...
public class QuantityTest {
    ...
    @Test
    public void thirtySixFahrenheitShouldBeBetterThanZeroCelsius() {
        var thirtySixFahrenheit = new ScaledQuantity(36, Unit.FAHRENHEIT);
        var zeroCelsius = new ScaledQuantity(0, Unit.CELSIUS);
        assertTrue(thirtySixFahrenheit.betterThan(zeroCelsius));
    }
}
